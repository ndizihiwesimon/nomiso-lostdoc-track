...
include 'connect.php';
 ...
 if (isset($_SESSION['locked']) AND $_SESSION['locked']==1) {
     # code...
...
$dataf = "SELECT clstatus FROM client WHERE clid = $user";
    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="client-home.php"><img class="main-logo" src="img/logo/logo.png" alt="" /></a>
...
if ($rowa=$resa->fetch()) {
    if ($rowa['clphoto'] !== '') {
        # code...
        ?>
     <a href="#"><img src="<?php echo $rowa['clphoto'];  ?>" alt="" /></a>
     <?php 
    }
    else
    {
 ...
 <a href="#"><img src="avatar/none.jpg" alt="" /></a>
        <?php
                    ...
                    ?>
					<h2>Online<span class="min-dtn"> User</span></h2>
				</div>
                    ...
                    <ul class="metismenu" id="menu1">
                        <li>
                            <a class="has-arrow" href="#">
								   <i class="icon nalika-upload icon-wrap"></i>
								   <span class="mini-click-non">Lost</span>
								</a>
                            <ul class="submenu-angle" aria-expanded="true">
                                <li><a title="Add Lost Doc" href="lost-edit.php"><span class="mini-sub-pro">Add record</span></a></li>
                                <li><a title="Added record" href="lost-view.php"><span class="mini-sub-pro">View Added</span></a></li>
                        ...
                        <li>
                            <a class="has-arrow" href="#" aria-expanded="false"><i class="icon nalika-forms icon-wrap"></i> <span class="mini-click-non">Report</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="Report for lost doc" href="#"><span class="mini-sub-pro">Lost Report</span></a></li>
                                <li><a title="Report For Found Doc" href="#"><span class="mini-sub-pro">Found Report</span></a></li>
                            </ul>
                        </li>
...
$name = $rowo['clfname']; 
$photo = $rowo['clphoto']; 
$photocol = $rowo['clphoto'];
}
}
else
{
  
$listo = "SELECT * FROM users WHERE userid=$sender";
$resulto = $pdo->query($listo);
while ($rowo=$resulto->fetch()) {
        
$name = $rowo['ufname']; 
$photocol = $rowo['uphoto'];
$photo = 'admin/'.$rowo['uphoto'];                           
                         }
...
?>  
                                                            ...
                                                            <li>
                                                                <a href="client-message.php?rec_id=<?php echo $sender;  ?>&user=<?php echo $user;  ?>">
...
//display user avatar
    if ($photocol !== '') {
        # code...
        ?>
     <img  src="<?php echo $photo;  ?>" width="100" height="100" alt="" />
     <?php 
    }
    else
    {
        ?>
 <img src="avatar/none.jpg" width="100" height="100" alt="" />
        <?php
    }
   ?>
                                                                    </div>
...
$list="SELECT * FROM notification WHERE notsender=$mine || notreceiver=$mine order by nottime DESC limit 10";
...
$yours=$row['notsender'];
$list2 = "SELECT * FROM users WHERE userid=$yours";
$result2 = $pdo->query($list2);
while ($row2=$result2->fetch()) {
...
?>                                                           
                                                ...
                                                <li class="nav-item">
                                                    <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
															<span class="admin-name"><?php echo $_SESSION['client_name'];  ?></span>
															<i class="icon nalika-user"></i>
														</a>
                                                    <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                        
                                                        <li><a href="client-profile.php"><span class="icon nalika-user author-log-ic"></span> My Profile</a>
                                                        </li>

...
$list="SELECT * FROM notification WHERE notuser = 'Client' && notsender=$mine || notreceiver=$mine order by nottime DESC";
...
$photo = $row2['uphoto'];
                        ...
                        ?>
                                    ...
                                    <tr>
                                    <td><a href="document-view.php?docid=<?php echo $row['notdoc'];?>">
                                        <?php

...
include 'header.php';
  ...
  if (isset($_GET['dis_id'])) {
    ...
    $actsql = "INSERT INTO activitylog(actdesc,actuser,actuserid) VALUES('Disabled Organization user','Admin',$actuserid)";
   ...
   if (isset($_GET['en_id'])) {
    ...
    $actsql = "INSERT INTO activitylog(actdesc,actuser,actuserid) VALUES('Enabled Organization user','Admin',$actuserid)";
    //use exec() because no results are returned
    $pdo->exec($sql);
    $pdo->exec($actsql);
   // echo "Record deleted successfully";
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            <h4>Company Users List</h4>
                            <div class="add-product">
                                <a href="org-edit.php">Add user</a>
                            </div>
                            <table>
                                <tr>
                                    <th>Photo</sub></th>
...
?>
                                    ...
                                    <td>
                                        <button data-toggle="tooltip" onclick="location.href='org-edit.php?org_id=<?php echo $fet['userid'];  ?>'" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button>
                                        <?php
                                        if ($fet['ustatus'] === '1') {
                                            # code...
                                            ?>

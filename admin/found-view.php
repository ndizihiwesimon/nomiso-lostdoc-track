...
include 'header.php';
 ...
 if (isset($_GET['del_id'])) {
    ...
    $pdo->exec($sql);
    $actsql = "INSERT INTO activitylog(actdesc,actuser,actuserid) VALUES('Deleted found document record','Admin',$actuserid)";
    $pdo->exec($actsql);
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            <div class="add-product">
                                <a href="found-edit.php">Add Found</a>
                            </div>
                            <table>
                                <tr>
                                    <th>Image</th>
...
$list = "SELECT * FROM users INNER JOIN document ON document.docposter=users.userid INNER JOIN documenttype ON documenttype.dtypeid=document.doctype WHERE  document.docposter =$userid AND document.docstate='1' AND document.docuser = 'Admin' order by document.docregdate DESC";

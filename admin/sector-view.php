...
$locaa = "SELECT * FROM users INNER JOIN sector ON sector.sectid=users.uaddress INNER JOIN district ON district.distid=sector.district INNER JOIN province ON province.provid=district.province WHERE users.utype='Sector' AND users.reguser = $mine order by users.uregdate DESC";
...
?>
                                    ...
                                    <td>
                                        <button data-toggle="tooltip" onclick="location.href='sector-edit.php?ssector_id=<?php echo $fetchh['userid'];  ?>'" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button>

...
if(isset($_POST['oregister']) || isset($_POST['oupdate'])){
    ...
    $actsql = "INSERT INTO activitylog(actdesc,actuser,actuserid) VALUES('New branch user record','Admin',$online)";
    $pdo->exec($actsql);
    
 ?>
<script type="text/javascript">
   window.setTimeout(function() {
    window.location.href = 'branch-edit.php';
}, 2000); 
</script>
  ...
  <?php
    ...
    {
    $actsql = "INSERT INTO activitylog(actdesc,actuser,actuserid) VALUES('Updated branch user record','Admin',$online)";
    $pdo->exec($actsql);            
 ?>
<script type="text/javascript">
   window.setTimeout(function() {
    window.location.href = 'branch-view.php';
}, 2000); 
</script>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                <ul id="myTab3" class="tab-review-design">
                                    <li class="active"><a href="#description"><i class="icon nalika-edit" aria-hidden="true"></i>Add branch user</a></li>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                     <form method="POST" action="branch-edit.php">
